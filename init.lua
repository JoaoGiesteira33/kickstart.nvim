...
require('lazy').setup({
  ...
  },
  {
    ...
    dependencies = {
      ...
      -- Allows extra capabilities provided by nvim-ufo
    ...
    config = function()
      ...
      vim.o.foldlevel = 99 -- Set high fold level
      vim.o.foldlevelstart = 99 -- Open files unfolded by default
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'angular', 'bash', 'c', 'css', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
